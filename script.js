    ...
    methods: {
      ...
      formatText: function () {
        ...
        for (i = 0; i < a.length; i++) {
          // str += a[i].key + "\n";
          // str += a[i].value + "\n";
          // if (a[i].key == "id_token" || a[i].key == "access_token") {
          //   str += a[i].decoded + "\n";
          // }
